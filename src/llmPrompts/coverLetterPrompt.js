...
export const coverLetterSchema = {
  ...
  properties: {
    opening_paragraph: {
      type: "string",
      description: "The opening paragraph that introduces the candidate and expresses interest in the position",
    },
    body_paragraphs: {
      type: "array",
      items: {
      ...
      minItems: 2,
      maxItems: 3,
      description: "2-3 body paragraphs highlighting relevant experience, skills, and achievements",
    },
    closing_paragraph: {
      type: "string",
